...
function VideoTitle({title,overview}) {
  return (
    <div className='w-full h-screen pt-[15%] px-12 z-10 absolute text-white bg-gradient-to-r from-[#00000097]'>
      <h1 className='text-4xl font-bold pb-5 '>{title}</h1>
      <p className='text-1.5xl font-bold w-1/3 mb-2'>{overview}</p>
      <div>
